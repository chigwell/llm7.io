            ...
            >
              ...
              <div className="mt-8 px-4 max-w-2xl text-gray-700 text-sm text-center">
                <p className="text-justify">
                  LLM7.io offers a free tier supported by donors and two paid subscriptions: <b>Vibe</b> (higher limits for chat) and <b>Pro</b> (highest limits plus JSON mode, function calling, and Pro models).
                </p>
                <p className="text-justify">
